...
internal class KaFirCompilerFacility(
    ...
    private fun compileUnsafe(
        ...
        val dependencyFilesNeedingOnlyResolution = dependencyFiles - compilationPeerData.dependencyFilesContainingInlineFunction
        ...
        compilationPeerData.dependencyFilesContainingInlineFunction.forEach { dependencyFile ->
