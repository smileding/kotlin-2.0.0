...
class TransformerForAddingAnnotations(val context: IrPluginContext) : IrElementVisitorVoid {
    companion object {
        ...
        private val simpleAnnotationId = ClassId(FqName("org.jetbrains.kotlin.fir.plugin"), Name.identifier("SimpleAnnotation"))
        private val arrayAnnotationId = ClassId(FqName("org.jetbrains.kotlin.fir.plugin"), Name.identifier("ArrayAnnotation"))
