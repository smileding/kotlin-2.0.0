...
//            map.put(EXPRESSION_REQUIRED, ...) // &
        ...
        map.put(WRAPPED_LHS_IN_ASSIGNMENT, "Wrapping the LHS in parentheses, labels or annotations is only allowed when resolving to augmented assignment operators, not regular assignments or the 'set' operator.")
